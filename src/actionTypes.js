...
export const SET_TASK_SESSION = 'FLOCS.SET_TASK_SESSION';
...
export const EVOLVE_WORLD = 'FLOCS.EVOLVE_WORLD';
...
export const SHOW_INSTRUCTIONS = 'FLOCS.SHOW_INSTRUCTIONS';
export const SEEN_INSTRUCTION = 'FLOCS.SEEN_INSTRUCTION';
export const SET_STUDENT = 'FLOCS.SET_STUDENT';
