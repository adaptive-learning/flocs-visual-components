...
import { showInstructions, seenInstruction } from '../actionCreators/instructions';
...
const getProps = (state) => ({
  activeInstructionIndex: state.flocsComponents.instructionLayer.activeInstructionIndex,
